 ...
 */
#define FLASHCACHE_NUM_WRITEBACK_SYSCTLS	27
 ...
 * is 1 more than then number of sysctls.
 */
#define FLASHCACHE_NUM_WRITETHROUGH_SYSCTLS	16
...
flashcache_find_sysctl_data(struct cache_c *dmc, ctl_table *vars)
{
	...
	//=======================
	else if (strcmp(vars->procname, "lwc_whitelist_size") == 0) 
		return &dmc->sysctl_lwc_whitelist_size;
	else if (strcmp(vars->procname, "lwc_window_size") == 0) 
		return &dmc->sysctl_lwc_window_size;
	else if (strcmp(vars->procname, "lwc_window_num") == 0) 
		return &dmc->sysctl_lwc_window_num;
	else if (strcmp(vars->procname, "lwc_window_threshold") == 0) 
		return &dmc->sysctl_lwc_window_threshold;
	else if (strcmp(vars->procname, "lwc_policy") == 0) 
		return &dmc->sysctl_lwc_policy;
	//=======================
