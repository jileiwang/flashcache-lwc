...
/* ADDED by shao for LWC */
	//#define NUM_ARRAY_LENTH		52
	#define HIT_PERCENTAGE		20  //means 1/20	
	#define WHITE_SHEET_LENGTH		20
/* */

//#define WHITE_LIST_LENGTH 50
//=========================
...
#define NUM_BLOCK_HASH_BUCKETS		512
	...
	//===================
	int 		lwc_whitelist_len;
	int 		lwc_whitelist_pos;
	sector_t	*lwc_whitelist;
	//===================
};
...
struct flashcache_stats {
	...
	//================
	unsigned long bio_arrival;
	unsigned long lwc_hits;
	unsigned long lwc_whitesheet_writes;

	unsigned long writes_shadow;
	unsigned long reads_shadow;

	unsigned long lwc_invalid_reject;
	//================

	unsigned long ssd_replaces;
...
#define PENDING_JOB_HASH_SIZE		32
	...
	//========================
	int sysctl_lwc_whitelist_size;
	int sysctl_lwc_window_size;
	int sysctl_lwc_window_num;
	int sysctl_lwc_window_threshold;
	int sysctl_lwc_policy;
	//========================

	/* ADDED by shao */
	int sysctl_lwc_enable;
	int		mywhitesheet_len;
	int 		mywhitesheet_pos;
	sector_t		*mywhitesheet;
	/* */
